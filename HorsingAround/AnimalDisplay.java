...
public class AnimalDisplay extends JComponent implements ActionListener
{
    ...
    public AnimalDisplay()
    {
        ...
        button = new JButton("Sort animals from tallest to shortest");
        button.setActionCommand("Sort animals from tallest to shortest");
        button.addActionListener(this);
        frame.getContentPane().add(button);
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        else if (command.equals("Sort animals from tallest to shortest")){
