...
public class BlackjackDisplay
{
    ...
    private void updateDisplay(boolean showDealerCard)
    {
        ...
        if (dealerHand.size() > 0)
        {
            if (showDealerCard)
                ...
                grid.setImage(new Location(0, 0), "C:/Users/14058/OneDrive/Desktop/APCS-Projects-Extended/Blackjack/Cards/back.gif");
        }
    ...
    {
        return "C:/Users/14058/OneDrive/Desktop/APCS-Projects-Extended/Blackjack/Cards/" + card.getRank() + "cdhs".charAt(card.getSuit()) + ".gif";
    }
}